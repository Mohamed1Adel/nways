                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header">
                                <div class="card-title">كن معنا لأجلهم - الدفعة الثانية</div>
                            </div>
                            <div class="card-body">
                                <table id="data-export" class="table table-bordered text-nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                            <?php
                                                $i = 1;
                                                $ddaa = mysqli_query($conectDB, "SELECT * FROM form002 ORDER BY `id` DESC");
                                                    while ($data = mysqli_fetch_array($ddaa)) {
                                                        echo '<tr row="'.$data['id'].'">
                                                                ...
                                                                <td id="Course_Program__'.$data['id'].'">'.$data['Course_Program'].'</td>
                                                            </tr>';
                                                    }
                                                $i++;
                                            ?>	
