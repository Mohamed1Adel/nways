...
if (is_numeric($id)) {
    $sql = "SELECT * From rooms WHERE hotel_id=$id AND status = 1";
    $result = $conectDB->query($sql);
        ...
        while ($roww = $result->fetch_assoc()) {
            ...
            <div class="list-content">
                <div class="main-img list-img room-img">
                    ...
                    <div id="carouselExampleInterval'.time() .''.$roww['id'].'" class="carousel slide" data-bs-ride="carousel" style="height:256px !important">
  <div class="carousel-inner" style="height:256px !important">
  ...
  if(!empty($room_images)){
    for( $i = 0; $i < count($room_images);$i++){
        if($i == 0){
            echo'
            <div class="carousel-item active" data-bs-interval="2000">
<img src="../Admin/back/uploads/'.$room_images[$i].'" class="d-block w-100"
alt="..." style="height:256px !important;">
</div>
            ';
        }else{
echo'
<div class="carousel-item " data-bs-interval="2000" style="height:256px !important">
<img src="../Admin/back/uploads/'.$room_images[$i].'" class="d-block w-100" alt="...">
</div>
';
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval'.time() .''.$roww['id'].'" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval'.time() .''.$roww['id'].'" data-bs-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Next</span>
  </button>
</div>
                ...
                <div class="list-info room-info">
                    ...
                    <div class="d-flex align-items-center gap-5">
                        <p class="block-minorr m-0">Beds : '.$roww['pads'].'</p>
